        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                String body = String.format(
                        "{\"content\":\"%s\",\"username\":\"Meteor SpawnerNotifier\",\"embeds\":[{\"title\":\"Spawner Alert\",\"description\":\"%s spawner(s) at %d, %d\",\"color\":15158332,\"fields\":[{\"name\":\"Server\",\"value\":\"%s\",\"inline\":true}]}]}",
                        escape(ping), count, cx, cz, escape(server));
